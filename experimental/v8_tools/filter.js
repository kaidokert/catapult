...
const menu = new Vue({
  ...
  computed: {
    ...
    optionsFirstElement() {
      ...
      if (this.chosenBenchmark === BENCHMARK_OPTIONS[1]) {
        return this.firstDurationComponent;
      }
    ...
    optionsSecondElement() {
      ...
      if (this.chosenBenchmark === BENCHMARK_OPTIONS[1]) {
        return this.secondDurationComponent();
      }
    ...
    optionsThirdElement() {
      ...
      if (this.chosenBenchmark === BENCHMARK_OPTIONS[1]) {
        return this.thridDurationComponent();
      }
    ...
    optionsFourthElement() {
      ...
      if (this.chosenBenchmark === BENCHMARK_OPTIONS[1]) {
        return this.fourthDurationComponent();
      }
    ...
    optionsFifthElement() {
      ...
      if (this.chosenBenchmark === BENCHMARK_OPTIONS[1]) {
        return this.fifthDurationComponent();
      }
  ...
  methods: {
    ...
    apply() {
      ...
      const elements = [];
      elements.push(this.secondElement, this.thirdElement, this.fourthElement,
          this.probe, this.fifthElement, this.sixthElement);
