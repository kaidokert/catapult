...
Vue.component('data-table', {
  ...
  methods: {
    ...
    getSampleByStoryBySubdiagnostics(entry, sampleArr, guidValue, globalDiag) {
      ...
      for (const e of sampleArr) {
        ...
        let diagnostic = '';
        if (e.diagnostics.hasOwnProperty(globalDiag)) {
          diagnostic = guidValue.
              get(e.diagnostics[globalDiag]);
        } else {
          diagnostic = guidValue.
              get(e.diagnostics.benchmarkStart);
        }
  ...
  watch: {
    ...
    //  metric, multiple ses, a single main diagnostic and multiple
