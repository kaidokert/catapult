...
# this number has been tested, and it works from milestone 45 to 68
MAX_RETRY_COUNT = 5
...
def GetChromiumLog(revision, count=10):
  ...
  # we skip the useless character at the front of the json that is sent back
  # to us
...
def GetBranchInfo(milestone, branch):
  ...
  Raises:
    MappingGenerationFailed: this would be raised if no log is incrementing the
      version
  """
