...
class TestGetLatestAvailableVersionURI(TestCase):
  ...
  @mock.patch('subprocess.call')
  def testGetLatestAvailableVersionURI_failedToFound(self, subprocess_call):
...
class TestGetAPK(TestCase):
  ...
  def testGetAPK_localApkNotExists(
    ...
    get_latest_available_version_uri.return_value = None
    download_apk_from_uri.result_value = None
    get_local_apk.return_value = 'path_to_apk'
