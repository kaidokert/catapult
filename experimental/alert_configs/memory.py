...
# For Chrome, by default we alert on allocated_objects, as that tends to be a
# more stable metric. See crbug.com/736506.
...
DEFAULT_ALERTS = (
    ...
    # v8 team wants to alert on effective_size too.
