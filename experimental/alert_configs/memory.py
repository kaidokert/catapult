...
# yet and some teams (e.g. v8) want to keep effective_size alerts regardless.
...
DEFAULT_ALERTS = (
    # Metrics ready to report allocated_objects.
    ...
    # Metrics not ready yet, or where effective_size is still important.
