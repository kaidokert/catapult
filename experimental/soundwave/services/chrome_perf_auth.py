...
USER_CREDENTIALS_FILE = os.path.normpath(os.path.join(
...
def GetUserCredentials(flags):
  ...
  Args:
    flags: An argparse.Namespace as returned by argparser.parse_args; including
      oauth2client.tools.argparser flags.
  """
  store = oauth2client.file.Storage(USER_CREDENTIALS_FILE)
