...
function authCallback(request) {
  ...
  function testApi() {
    Logger.log(getApiData('https://chromeperf.appspot.com/api/alerts/history/80?sheriff=V8%20Telemetry%20RuntimeStats'));
  }
  ...
  function emailBenchmarkOwners() {
    ...
    for (var benchmark in benchmarkBugs) {
      ...
      htmlBody += '<br><br>If you are not the correct benchmark owner, please see ' +
                  '<a href="https://docs.google.com/document/d/15nGIim41zVd8pA0AAtLmAdJVKE695hluW27cZp0rSjo' +
                  '/edit#heading=h.u40jnn38ebdr">go/change-benchmark-owner</a>.';
