...
class Project(object):
  ...
  def CalcLoadSequenceForModuleNames(self, module_names, excluded_scripts=None):
    print module_names
    modules = [self.loader.LoadModule(module_name=name, excluded_scripts=excluded_scripts) for
