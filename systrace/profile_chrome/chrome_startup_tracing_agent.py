...
class ChromeStartupTracingAgent(tracing_agents.TracingAgent):
  ...
  def _RemoveTracingFlags(self):
    """Removes tracing flags from current command line.

    Flags removed are specified in the constant flag list. Specify
    more tracing flags in the list if needed. Removing the current
    tracing flags prevents the error of the current state affecting
    the specified tracing format.
    """
    ...
    # with prefix from our constant flag list to satisfy this requirement
