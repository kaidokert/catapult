...
class ChromeStartupTracingAgent(tracing_agents.TracingAgent):
  ...
  def _RemoveTracingFlags(self):
    ...
    Flags removed are specified in the constant flag list of flag
    substrings. Specify more tracing flags in the list if needed.
    Removing the current tracing flags prevents the error of the
