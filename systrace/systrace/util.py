...
def get_tracing_path():
  ...
  Returns:
    /sys/kernel/debugfs for device with debugfs mount support;
    otherwise /sys/kernel/tracing for device with tracefs support.
  """
  mount_info_args = ['mount']
  parser = OptionParserIgnoreErrors()
  parser.add_option('-e', '--serial', dest='device_serial', type='string')
  options, _ = parser.parse_args()  # pylint: disable=unused-variable
