...
Virtual Port:        |  1  |  5  |  2  |  3  | 4.1 | 4.2 | 4.3 | 4.4 | 4.5 |
"""
V3_LAYOUT = {1: 1, 2: 3, 3: 4, 4: {1: 5, 2: 6, 3: 7, 4: 8, 5: 9}, 5: 2}
...
def _is_v3_hub(node):
  """Check if a node is V3 Labs hub which has 9 USB-C ports.
  See V3_LAYOUT for the topology.
  """
...
V3 = HubType(_is_v3_hub, V3_LAYOUT)
