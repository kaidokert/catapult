...
class FastbootUtilsFindAndVerifyPartitionsAndImages(FastbootUtilsTest):
  ...
  def testFindAndVerifyPartitionsAndImages_noFile_OptionalImage(self):
    with mock.patch('os.listdir', return_value=['test']):
  ...
  def testFindAndVerifyPartitionsAndImages_noFile_OptionalImageAB(self):
    with mock.patch('os.listdir', return_value=['test']):
      fastboot_utils._FindAndVerifyPartitionsAndImages(['vendor'], 'test',
                                                       True)
      fastboot_utils._FindAndVerifyPartitionsAndImages(['cache'], 'test', True)
