...
class AdbWrapper(object):
  ...
  class PersistentShell(object):
    ...
    def IterRunCommand(self, command, include_status, close=False, expect_crash=False):
    ...
    def RunCommand(self, command, close=False, keepends=False, expect_crash=False):
      """Runs an ADB command and yields the output line by line.
