...
class AdbWrapper(object):
  ...
  class PersistentShell(object):
    ...
    def __init__(self, serial, registry=None):  #registry=None):
  ...
  def __init__(self, device_serial, persistent_shell=False):
    ...
    self._idle_persistent_shells = None
    ...
    if persistent_shell:
      ...
      self._idle_persistent_shells = Queue()
      ...
      shell.Start()
      self._idle_persistent_shells.put(shell)
  ...
  def ReAddAdb(self, adb):
    ...
    """
    if self._idle_persistent_shells:
      self._idle_persistent_shells.put(adb)
  ...
  def KillAllPersistentAdbs(self):
    ...
    if self._idle_persistent_shells:
      try:
        while True:
          self._idle_persistent_shells.get(block=False)
      except Empty:
        pass
    self._lock.release()
  ...
  def _get_a_shell(self):
    try:
      return self._idle_persistent_shells.get(block=False)
    except Empty:
      self._lock.acquire()
      shell = self.PersistentShell(self._device_serial, registry=self)
      shell.Start()
