...
class AdbWrapper(object):
  ...
  class PersistentShell(object):
    ...
    def HardStop(self):
      ...
      if self._process is not None and self._process.poll() is None:
        ...
        # We're going to kill it anyways. This tries to prevent defunct
        # processes by reading the exit code from the kill.
  ...
  def _Shell(self, command, timeout, retries):
    ...
    print("status reutnred will be: %s" % output[output_end +1:])
