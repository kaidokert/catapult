...
class AdbWrapper(object):
  ...
  def Version(cls):
    ...
    and forcing a server restart: http://b/218716282#comment8

    Prefer to call ReleaseVersion instead.
    """
  ...
  def ReleaseVersion(cls):
    ...
    Prefer to use this to gate features and fixes: http://b/218716282#comment8
    """
  ...
  def InstallMultiple(self,
    ...
    if (du_version.LooseVersion(self.ReleaseVersion()) <=
      ...
      # Workaround for http://b/218716282#comment8.
