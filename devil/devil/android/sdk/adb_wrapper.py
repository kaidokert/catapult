...
class AdbWrapper(object):
  ...
  class PersistentShell(object):
    ...
    def IterRunCommand(
      ...
      if close:
        ...
        self._process.communicate(six.ensure_binary(send_cmd))
        self._process = None
        output_lines = [six.ensure_str(line) for line in list(self._outq.queue)]
        if include_status:
  ...
  def ReAddAdb(self, adb):
    ...
    the need to start up a new thread.
    """
