...
class DeviceUtilsReadFileTest(DeviceUtilsTest):
  ...
  def check_ReadFileWithEncodingErrors(self, encoding, errors):
    tmp_host_dir = '/tmp/dir/on.host/'
  ...
  def testReadFile_AsBytes(self):
    self.check_ReadFileWithEncodingErrors(None, 'replace')

  def testReadFile_NotUtf8_Replace(self):
    self.check_ReadFileWithEncodingErrors('utf8', 'replace')

  def testReadFile_NotUtf8_Ignore(self):
    self.check_ReadFileWithEncodingErrors('utf8', 'ignore')

  def testReadFile_NotCp1251_Replace(self):
    self.check_ReadFileWithEncodingErrors('cp1251', 'replace')

  def testReadFile_NotCp1251_Ignore(self):
    self.check_ReadFileWithEncodingErrors('cp1251', 'ignore')
