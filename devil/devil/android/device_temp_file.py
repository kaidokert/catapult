...
class DeviceTempFile(object):
  ...
  def close(self):
    ...
    def delete_temporary_file():
      try:
        ...
        if self.run_as_pkg_name:
          cmd = 'run-as {} {}'.format(self.run_as_pkg_name, cmd)
  ...
  def _initialize_file(self):
    touch_cmd = 'touch {}'.format(self.name)
    chmod_cmd = 'chmod uga+rw {}'.format(self.name)
    if self.run_as_pkg_name:
      touch_cmd = 'run-as {} {}'.format(self.run_as_pkg_name, touch_cmd)
      chmod_cmd = 'run-as {} {}'.format(self.run_as_pkg_name, chmod_cmd)
