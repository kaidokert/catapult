...
class DeviceUtils(object):
  ...
  def RunShellCommand(self, cmd, shell=False, check_return=False, cwd=None,
    ...
    Args:
      ...
      timeout: timeout in seconds
      retries: number of retries
      keep_logs_on_timeout: If True, will reduce specified timeout by 3 seconds
        for the internal adb command, which allows to retrive logs on timeout.
        Note that logs will not be produced if adb command hangs and does not
        repsect the reduced timeout.
