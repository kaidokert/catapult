...
class DeviceUtils(object):
  ...
  @decorators.WithTimeoutAndRetriesFromInstance()
  def GetWebViewUpdate(self, timeout=None, retries=None):
    """Get the WebView update command info on the device.
    ...
    # command is not available pre-monochrome, and doesn't work in nougat
    if self.build_version_sdk < version_codes.OREO:
      return result
