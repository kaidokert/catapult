...
class DeviceUtils(object):
  ...
  def WaitUntilFullyBooted(self,
    ...
    Args:
      ...
      decrypt: A boolean indicating if we shoule wait for decryption to
        complete or not.
        This is only meanful for the device with full-disk encryption (FDE).
      timeout: timeout in seconds
      retries: number of retries
  ...
  def Reboot(self,
    ...
    Args:
      ...
      decrypt: A boolean indicating if we should wait for decryption
        to be completed after the reboot.
        The option has no effect unless |block| is also True, and is only
        meanful for the device with full-disk encryption (FDE).
      timeout: timeout in seconds
      retries: number of retries
