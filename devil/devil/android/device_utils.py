...
class DeviceUtils(object):
  ...
  def IsApplicationInstalled(
      self, package, versionCode=None, timeout=None, retries=None):
    """Determines whether a particular package is installed on the device.

    Args:
      package: Name of the package.
      versionCode: The version of the package to check for as an int, if
          applicable. Ignored if a matching package can be found via
          "pm list packages" without appending the version.
    ...
    if versionCode != None:
      package = '%s_%d' % (package, versionCode)
