...
TELEMETRY_SUPPORT_GROUP = 'telemetry_chrome_test_support'
...
def GenerateBuildFile(root_path, output_path, chromium):
  ...
  CATAPULT_GROUP = CATAPULT_PREFIX + ':' + TELEMETRY_SUPPORT_GROUP
  if chromium:
    ...
    for line in contents:
      if CHROMIUM_GROUP in line:
        ...
        build_file.write('\n\n')
      elif CATAPULT_GROUP in line:
        line = line.replace(CATAPULT_GROUP, ':' + TELEMETRY_SUPPORT_GROUP)
...
def main(argv):
  ...
  parser.add_option("--chromium", action="store_true", default=False,
                    ...
                    "This is for the purpose of running try jobs.")
