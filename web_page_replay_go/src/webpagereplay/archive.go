...
func (a *Archive) Merge(input *Archive) error {
	var cerr error
	var nofAddedRequests = 0
	var nofSkippedRequests = 0
	input.ForEach(func(fullURL *url.URL, req *http.Request, resp *http.Response) bool {
