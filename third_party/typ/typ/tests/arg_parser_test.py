...
class ArgumentParserTest(unittest.TestCase):
    ...
    def test_filter_coverage_options(self):
        ...
        args = parser.parse_args(['--coverage', '--isolated-script-test-filter=blinkpy.unittest.Test1::blinkpy.unittest.Test2'])
        self.assertFalse(args.coverage)

        args = parser.parse_args(['--coverage', '--test-filter=blinkpy.unittest.Test1::blinkpy.unittest.Test2'])
        self.assertFalse(args.coverage)
