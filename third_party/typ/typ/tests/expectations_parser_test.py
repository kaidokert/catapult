...
"""
    ...
    def testNonDeclaredSystemConditionTagRaisesException(self):
        ...
        self.assertEqual(str(context.exception),
            ...
            'There may have been a typo in an expectations file. '
            'Please make sure the aforementioned tag is declared in '
    ...
    def testNonDeclaredSystemConditionTagsRaisesException_PluralCase(self):
        ...
        self.assertEqual(str(context.exception),
            ...
            'in any expectations file. There may have been a typo in '
            'an expectations file. Please make sure the aforementioned '
            'tags are declared in an expectations file.')
