...
class TestHostReceivesProcessOutput(unittest.TestCase):
    ...
    def testFinalOutputContainsAllChildOutput(self):
        ...
        self.assertIn('  Started testChildStderrIsInTypFinalOutput',
                      sys.stdout.getvalue())
        self.assertIn('    Started testWriteToStderr', sys.stdout.getvalue())
    ...
    def testChildStderrIsInTypFinalOutput(self):
        ...
        self.assertIn('  Started testWriteToStderr', sys.stderr.getvalue())
