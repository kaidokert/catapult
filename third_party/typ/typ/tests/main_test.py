...
class TestCli(test_case.MainTestCase):
    ...
    def test_implement_test_prefix_name_exclusion_in_finished_test_output(self):
        files = PASS_TEST_FILES
    ...
    def test_implement_test_prefix_name_exclusion_in_expectations_files(self):
        files = {'fail_test.py': FAIL_TEST_PY,
                 'expectations.txt': d("""\
                  # tags: [ foo bar ]
    ...
    def test_implement_test_prefix_name_exclusion_in_skip_glob(self):
        files = {'fail_test.py': FAIL_TEST_PY}
        _, out, _, files = self.check(
    ...
    def test_implement_test_prefix_name_exclusion_in_json_results(self):
        files = {'fail_test.py': FAIL_TEST_PY}
        _, out, _, files = self.check(
            ['--test-name-prefix', 'fail_test.FailingTest.',
             '--write-full-results-to', 'full_results.json'],
    ...
    def test_implement_test_prefix_name_exclusion_for_tests_args(self):
    ...
    def test_implement_test_prefix_name_exclusion_for_file_list_arg(self):
    ...
    def test_implement_test_prefix_name_test_started_output(self):
        files = {'fail_test.py': FAIL_TEST_PY}
        _, out, _, files = self.check(
    ...
    def test_implement_prefix_name_exclusion_in_list_only_arg(self):
        files = {'output_test.py': OUTPUT_TEST_PY}
        _, out, _, files = self.check(
