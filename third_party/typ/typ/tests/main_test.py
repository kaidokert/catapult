...
class TestCli(test_case.MainTestCase):
    ...
    def test_retryonfail_exp_test_fail_expected_pass_output(self):
        files = {'fail_test.py': FAIL_TEST_PY,
                 'expectations.txt': d("""\
                  # tags: [ foo bar ]
        ...
        self.assertEqual(results['expected'],'RETRY_ON_FAIL')
        self.assertIn('is_unexpected', results)
        self.assertIn('is_regression', results)

    def test_retryonfail_exp_test_pass_expected_pass_output(self):
        files = {'pass_test.py': PASS_TEST_PY,
                 'expectations.txt': d("""\
                  # tags: [ foo bar ]
