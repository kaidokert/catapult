...
class TestCli(test_case.MainTestCase):
    ...
    def test_retryonfailure_run_test_retry_on_failure(self):
        ...
        self.assertIn('1 test passed, 0 skipped, 0 failures.\n', out)
        retry_flaky_test_output = (('Retrying failed test %s ' % test_name) +
                                   '(attempt #%d of 3)')
    ...
    def test_retryonfailure_test_retry_on_failure_expected_failure(self):
        test_name = ('pass_retry_on_failure_test'
                     '.PassRetryOnFailureTest.test_retry_on_failure')
        files = {'pass_retry_on_failure_test.py': PASS_TEST_RETRY_ON_FAILURE_PY,
                 'expectations.txt': d(
    ...
    def test_retryonfailure_regression(self):
        ...
        self.assertIn('0 tests passed, 0 skipped, 1 failure.\n', out)
        retry_flaky_test_output = ('Retrying failed test fail_test'
