...
class Expectation(object):
    ...
    def _set_string_value(self):
        ...
        Setting the _raw_results and _raw_tags list to the original lists during parsing
        stops unintended modifications to test expectations when rewriting files.
        """
