...
def _default_tags_are_equivalent(t1, t2):
    return t1 == t2
...
class TestExpectations(object):
    ...
    def parse_tagged_list(self, raw_data, file_name='',
                          tags_are_equivalent=_default_tags_are_equivalent):
        ...
        self._tags_are_equivalent = tags_are_equivalent
        ...
        for tag_set in self.tag_sets:
            for t1, t2 in itertools.product(s1, s2):
                if (t1 in tag_set and t2 in tag_set and
                    not self._tags_are_equivalent(t1, t2)):
                    return False
        return True
