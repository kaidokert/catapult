...
class TaggedTestListParser(object):
    ...
    def __init__(self, raw_data, append_prefix_to_test=''):
        self.tag_sets = []
        self.expectations = []
        self._tag_to_tag_set = {}
        self._append_prefix_to_test = append_prefix_to_test
    ...
    def _parse_expectation_line(self, lineno, line):
        ...
        tag_set_ids = set()
        test = self._append_prefix_to_test + test
...
class TestExpectations(object):
    ...
    def parse_tagged_list(self, raw_data, append_prefix_to_test=''):
        try:
            parser = TaggedTestListParser(raw_data, append_prefix_to_test)
