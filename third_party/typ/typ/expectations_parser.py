...
class Expectation(object):
    def __init__(self, reason=None, test='*', tags=None, results=None, lineno=0,
        ...
        self._encode_func = encode_func or uri_encode_spaces
        self.encoded_test = self._encode_func(self._test)
    ...
    def __eq__(self, other):
        return (self.reason == other.reason and self.test == other.test
                ...
                and self.encoded_test == other.encoded_test)
    ...
    def _set_string_value(self):
        ...
        pattern = self._encode_func(pattern)
        self._string_value = ''
        if self._reason:
