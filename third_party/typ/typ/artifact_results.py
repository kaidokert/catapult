...
class ArtifactResults(ArtifactResultsBase):
  ...
  def _GenerateRelativeArtifactPath(self, test_name, artifact_type,
                                    artifact_name):
    """Returns a path relative to the output directory for the artifact."""
