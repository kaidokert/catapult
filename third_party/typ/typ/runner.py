...
class Runner(object):
    ...
    def _print_test_finished(self, stats, result):
        ...
        # Determine any relevant expectations that affecting the test pass
        # status.
        bug_str = ''
...
def _run_one_test(child, test_input):
    ...
    (expected_results,
        should_retry_on_failure, _) = _get_expectation_information()
    ...
    if isinstance(test_case, TypTestCase):
        ...
        associated_bugs = test_case.associatedBugs
