    ...
    def _test_adder(self, test_set, classifier):
        ...
        def add_tests(obj):
            if isinstance(obj, unittest.suite.TestSuite):
                ...
                if not test_name in self.test_name_to_id:
                    classifier(test_set, obj)
                self.test_name_to_id[test_name] = obj.id()
...
class _Child(object):
    ...
    def __init__(self, parent):
        ...
        self.test_name_to_id = parent.test_name_to_id
    ...
    try:
        ...
        try:
            suite = child.loader.loadTestsFromName(
                child.test_name_to_id[test_name])
        except Exception as e:
