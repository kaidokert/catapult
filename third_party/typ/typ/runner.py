...
class Runner(object):
    ...
    def default_classifier(self, test_set, test):
        if (self.args.all
            ...
            or self.should_filter_with_test_filter_arg(test)):
    ...
    def should_filter_with_test_filter_arg(self, test_case):
        _validate_test_starts_with_prefix(
    ...
    def should_filter_with_positional_args(self, test_case):
        _validate_test_starts_with_prefix(
            self.args.test_name_prefix, test_case.id())
