...
import httplib2
import uritemplate
print('==== APICLIENT DISCOVERY IMPORT')
import sys
print('====== URITEMPLATE? ===== ', sys.modules)
# Local imports
...
print('==== APICLIENT DISCOVERY IMPORT 2')
# import oauth2client.oauth2client.client
# print('==== APICLIENT DISCOVERY IMPORT 3')
...
print('==== APICLIENT DISCOVERY IMPORT END')
