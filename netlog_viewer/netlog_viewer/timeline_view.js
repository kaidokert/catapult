...
var TimelineView = (function() {
  ...
  TimelineView.prototype = {
    ...
    toggleSelectionDiv_: function() {
      ...
      // Notify the graph view that it may need to update the canvas size. This isn's strictly necessary since that view will also poll to see when a resize has happened, but this makes the update happen right away.
