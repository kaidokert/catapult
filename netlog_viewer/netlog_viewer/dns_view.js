...
var DnsView = (function() {
  ...
  DnsView.prototype = {
    ...
    onLoadLogFinish: function(data) {
      return this.onHostResolverInfoChanged(
          data.hostResolverInfo, data.disabledDohProviders);
    },

    onHostResolverInfoChanged: function(
        hostResolverInfo, disabledDohProviders) {
      ...
      displayAsyncDnsConfig_(hostResolverInfo, disabledDohProviders);
   ...
   */
  function displayAsyncDnsConfig_(hostResolverInfo, disabledDohProviders) {
    // Clear the table.
    ...
    if (disabledDohProviders) {
      for (let disabledProvider of disabledDohProviders) {
        addNodeWithText(
