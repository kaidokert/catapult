      ...
      return [
        {
          ...
          testSuite: lineDescriptor.testSuites[0],
          testCase: lineDescriptor.testCases[0],
          cacheKey: lineDescriptor.testPath.replace(/\./g, '_'),
      ...
      for (const bot of lineDescriptor.bots) {
        for (const testCase of testCases) {
          ...
          fetchDescriptor.testPath = cp.TimeseriesCache.compileTestPath(
              fetchDescriptor);
          fetchDescriptor.cacheKey = fetchDescriptor.testPath.replace(
              /\./g, '_');
