  ...
  function mergeData(target, source) {
    if (target.revision === undefined) {
      ...
      if (target.diagnostics) {
        ...
        for (const [name, diagnostic] of target.diagnostics) {
          // Bypass type checks for speed.
          // TODO DiagnosticMap.setUnsafe()
          Map.prototype.set.call(shallowClone, name, diagnostic);
        }
