...
tr.exportTo('cp', () => {
  ...
  class TimeseriesIterator {
    ...
    findStartIndex_() {
      ...
      if (this.lineDescriptor_.minRev) {
        return tr.b.findLowIndexInSortedArray(
            this.timeseries_, getX, this.lineDescriptor_.minRev);
      }
      return 0;
    }
    ...
    findEndIndex_() {
      ...
      if (this.lineDescriptor_.maxRev) {
        return tr.b.findLowIndexInSortedArray(
            this.timeseries_, getX, this.lineDescriptor_.maxRev);
      }
