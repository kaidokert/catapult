  ...
  render() {
    ...
    return html`
      <div hidden="${!this.isExpanded}">
        ...
        <error-set .errors="${[...new Set([
    ...this.minimapLayout.errors, ...this.chartLayout.errors])]}">
        </error-set>
        ...
        <span
          ...
          <iron-icon
              id="options"
              icon="cp:settings"
              style="width: calc(${this.chartLayout.yAxisWidth}px - 8px);"
              tabindex="0"
        ...
        <chart-timeseries
            id="minimap"
            state-path="${this.statePath}.minimapLayout"
      ...
      <chart-timeseries
          id="chart"
          state-path="${this.statePath}.chartLayout"
      ...
      <div hidden="${!this.isExpanded}">
        <details-table
            id="details"
            state-path="${this.statePath}.details"
