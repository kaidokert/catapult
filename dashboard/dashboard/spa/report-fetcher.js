...
export class ReportFetcher {
  ...
  fetchCell_(fetchDescriptor, revIndex, revision) {
    return (async function* () {
      console.log('fetchCell_ start', fetchDescriptor.rowIndex, fetchDescriptor.fetchIndex, revIndex);
      const suiteBot = fetchDescriptor.suite + '/' + fetchDescriptor.bot;
      ...
      console.log('fetchCell_ end', fetchDescriptor.rowIndex, fetchDescriptor.fetchIndex, revIndex);
    }).call(this);
  }
}
