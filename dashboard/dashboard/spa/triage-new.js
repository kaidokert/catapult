...
tr.exportTo('cp', () => {
  ...
  TriageNew.actions = {
    ...
    label: (statePath, name) => async (dispatch, getState) => {
      dispatch({
        reducer: TriageNew.reducers.toggleLabel,
        statePath,
        name,
      });
    },
    ...
    component: (statePath, name) => async (dispatch, getState) => {
      dispatch({
        reducer: TriageNew.reducers.toggleComponent,
        statePath,
        name,
      });
    },
  ...
  TriageNew.reducers = {
    toggleLabel: cp.ElementBase.statePathReducer((state, action) => {
    ...
    toggleComponent: cp.ElementBase.statePathReducer((state, action) => {
