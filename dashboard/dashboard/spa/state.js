...
tr.exportTo('cp', () => {
  ...
  class Element extends ReduxMixin(Polymer.Element) {
    ...
    _empty(seq) {
      ...
      if (seq instanceof Array) return seq.length === 0;
      if (seq instanceof Map || seq instanceof Set) return seq.size === 0;
      if (seq instanceof tr.v.HistogramSet) return seq.length === 0;
      return Object.keys(seq).length === 0;
    }
  }
