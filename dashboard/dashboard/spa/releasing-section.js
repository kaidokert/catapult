...
tr.exportTo('cp', () => {
  class ReleasingSection extends cp.Element {
    ...
    onKeydownSource_(e) {
      this.dispatch(ReleasingSection.keydownSource(this.sectionId, e.detail.value));
    }
  ...
  cp.sectionReducer('releasing-section.selectSource', (state, action, section) => {
    return DUMMY_RELEASING_SECTION;
  });

  cp.sectionReducer('releasing-section.clearSource', (state, action, section) => {
    return {
      source: {
        ...section.source,
        inputValue: '',
  ...
  cp.sectionReducer('releasing-section.keydownSource', (state, action, section) => {
    return {
      source: {
        ...section.source,
        inputValue,
