...
tr.exportTo('cp', () => {
  class ReleasingSection extends cp.Element {
    ...
    static updateLocation(sectionState) {
      return async (dispatch, getState) => {
        ...
        if (state.containsDefaultSection &&
          ...
          dispatch(cp.ChromeperfApp.routeChange('', {}));
          return;
        }
        const queryParams = {};
        ...
        dispatch(cp.ChromeperfApp.routeChange('releasing', queryParams));
      };
    }
    ...
    toggleEditing_() {
      this.dispatch(ReleasingSection.toggleEditing(this.sectionId));
    }

    static toggleEditing(sectionId) {
      return async (dispatch, getState) => {
        dispatch({
  ...
  cp.sectionReducer('releasing-section.toggleEditing',
      (state, action, section) => {
        return {
