...
import {BatchIterator, animationFrame, get} from './utils.js';
...
export default class ReportSection extends ElementBase {
  ...
  static async loadReports(statePath) {
    ...
    const minMinRevision = ReportControls.CHROMIUM_MILESTONES[
        state.milestone - 1];
    ...
    for (const templateInfo of reportTemplateInfos) {
      ...
      readers.push(new ReportFetcher(
          templateInfo, revisions, minMinRevision));
    }
