  ...
  for (const revision of [minRevision, maxRevision]) {
    for (let statistic of statistics) {
      ...
      scalars.push({
        unit,
        unitPrefix,
        value: row.data[revision].statistics[statistic],
      });
    }
  }
  for (let statistic of statistics) {
    ...
    const deltaValue = (row.data[maxRevision].statistics[statistic] -
    ...
    scalars.push({
      ...
      value: deltaValue / row.data[minRevision].statistics[statistic],
    });
    scalars.push({
      unit,
      value: deltaValue,
