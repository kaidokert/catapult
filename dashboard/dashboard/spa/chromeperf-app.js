...
import AlertsSection from './alerts-section.html';
import ChartSection from './chart-section.html';
import './cp-icons.html';
import './cp-loading.html';
import './cp-toast.html';
import './raised-button.js';
import './recent-bugs-request.html';
import ReportSection from './report-section.html';
import './session-id-request.html';
import './session-state-request.html';
import './test-suites-request.html';
import '/bower_components/app-route/app-location.html';
import '/bower_components/app-route/app-route.html';
import '/bower_components/chopsui/chops-header.html';
import '/bower_components/chopsui/chops-signin-aware.html';
import '/bower_components/chopsui/chops-signin.html';

const NOTIFICATION_MS = 5000;

class ChromeperfApp extends ElementBase {
  static get template() {
    return Polymer.html`
      <style>
        chops-header {
