...
tr.exportTo('cp', () => {
  ...
  ChromeperfApp.actions = {
    ...
    routeChanged: (mode, queryParams) =>
      async (dispatch, getState) => {
        ...
        if (mode === '' ||
          ...
          dispatch({reducer: ChromeperfApp.reducers.closeAllSections});
          return;
        }
        state = getState();
        ...
        if (state.sectionIds.length !== 1 ||
          ...
          dispatch({
            reducer: ChromeperfApp.reducers.newSection,
    ...
    closeSection: sectionId => async (dispatch, getState) => {
      dispatch({
        reducer: ChromeperfApp.reducers.closeSection,
        sectionId,
      });
      ...
      dispatch({reducer: ChromeperfApp.reducers.forgetClosedSection});
    },
  };
