...
export class DetailsFetcher {
  ...
  fetchNotes_(lineIndex, rangeIndex, fetchIndex) {
    return (async function* () {
      ...
      console.log('start', lineIndex, rangeIndex, fetchIndex, {...line.fetchDescriptors[fetchIndex], ...this.revisionRanges_[rangeIndex]});
      ...
      console.log('end', lineIndex, rangeIndex, fetchIndex);
    }).call(this);
  }
