    ...
    measurementOptions: cp.ElementBase.statePathReducer((state, action) => {
      return {
        ...
        measurement: {
          ...
          label: `Measurements (${action.measurements.length})`,
        },
      };
    }),
    ...
    testCaseOptions: cp.ElementBase.statePathReducer((state, action) => {
      return {
        ...
        testCase: {
          ...
          options: [
            {
              label: `All ${action.testCases.length} test cases`,
              isExpanded: true,
              value: '*',
              options: cp.OptionGroup.groupValues(action.testCases),
            },
          ],
          label: `Test cases (${action.testCases.length})`,
          tags: {
            ...state.testCase.tags,
