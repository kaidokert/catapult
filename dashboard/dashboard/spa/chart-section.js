...
tr.exportTo('cp', () => {
  ...
  ChartSection.State = {
    ...
    ...cp.ChartPair.State,
    descriptor: options => cp.TimeseriesDescriptor.buildState({
      suite: {
        selectedOptions: options.parameters.suites,
        isAggregated: options.parameters.suitesAggregated,
      },
      measurement: {
      ...
      bot: {
        ...
        isAggregated: options.parameters.botsAggregated,
      },
      case: {
        selectedOptions: options.parameters.cases,
        isAggregated: options.parameters.casesAggregated,
      },
    }),
    ...
    statistic: options => cp.MenuInput.buildState({
      label: 'Statistics',
      required: true,
      selectedOptions: (options || {}).statistics || ['avg'],
