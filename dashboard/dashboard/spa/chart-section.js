...
tr.exportTo('cp', () => {
  ...
  ChartSection.actions = {
    ...
    measurement: statePath => async (dispatch, getState) => {
      dispatch({
        reducer: ChartSection.reducers.updateTitle,
        statePath,
      });
      dispatch(ChartSection.actions.maybeLoadTimeseries(statePath));
    },
    ...
    measurementOptions: statePath => async (dispatch, getState) => {
      ...
      dispatch({
        reducer: ChartSection.reducers.measurementOptions,
        statePath,
    ...
    botOptions: statePath => async (dispatch, getState) => {
      ...
      // TODO This may need to fetch.
      dispatch({
        reducer: ChartSection.reducers.botOptions,
        statePath,
    ...
    testCaseOptions: statePath => async (dispatch, getState) => {
      ...
      // TODO This may need to fetch.
      dispatch({
        reducer: ChartSection.reducers.testCaseOptions,
        statePath,
    ...
    clearTimeseries: statePath => async (dispatch, getState) => {
      ...
      dispatch({
        reducer: ChartSection.reducers.clearTimeseries,
        statePath,
      });
    },
    ...
    loadTimeseries: statePath => async (dispatch, getState) => {
      ...
      dispatch({
        reducer: ChartSection.reducers.buildLegend,
        statePath,
        parameters,
      });
    ...
    chartClick: statePath => async (dispatch, getState) => {
      dispatch({
        reducer: ChartSection.reducers.chartClick,
        statePath,
      });
    },
    ...
    dotClick: (statePath, ctrlKey, lineIndex, datumIndex) =>
      async (dispatch, getState) => {
        dispatch({
          reducer: ChartSection.reducers.dotClick,
          statePath,
          ctrlKey,
          lineIndex,
          datumIndex,
        ...
        dispatch({
          reducer: ChartSection.reducers.receiveHistograms,
          statePath,
