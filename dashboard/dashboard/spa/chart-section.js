...
tr.exportTo('cp', () => {
  ...
  ChartSection.reducers = {
    receiveHistograms: cp.updatingReducer((section, action) => {
      return {
        isLoading: false,
    ...
    chartClick: cp.updatingReducer((section, action) => {
      return {
        chartLayout: {
          ...section.chartLayout,
          brushes: [],
    ...
    dotClick: cp.updatingReducer((section, action) => {
    ...
    dotMouseOver: cp.updatingReducer((lines, action) => {
    ...
    layoutChart: cp.updatingReducer((section, action) => {
      return {
        isLoading: false,
        title: action.title,
    ...
    toggleChartOnly: cp.updatingReducer((section, action) => {
      return {onlyChart: !section.onlyChart};
    }),

    clearTimeseries: cp.updatingReducer((section, action) => {
      return {
        chartLayout: false,
        minimapLayout: false,
        histograms: undefined,
    ...
    startLoadingTimeseries: cp.updatingReducer((section, action) => {
      return {isLoading: true};
    }),

    layoutRelatedTabs: cp.updatingReducer((section, action) => {
      return {relatedTabs: action.relatedTabs};
    }),

    brushChart: cp.updatingReducer((section, action) => {
    ...
    brushMinimap: cp.updatingReducer((section, action) => {
