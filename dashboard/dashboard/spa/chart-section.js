  ...
  class ChartSection extends cp.Element {
    ...
    static updateLocation(sectionState) {
      return async (dispatch, getState) => {
        ...
        const queryParams = {
          testSuite: components[0].selectedOptions.join(','),
          bot: components[1].selectedOptions.join(','),
          measurement: components[2].selectedOptions.join(','),
        };
        ...
        dispatch(cp.ChromeperfApp.routeChange('chart', queryParams));
      };
    }
