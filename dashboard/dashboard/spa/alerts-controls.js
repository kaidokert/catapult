...
export default class AlertsControls extends ElementBase {
  ...
  static async loadSheriffs(statePath) {
    ...
    if (state.sheriff.selectedOptions.length === 0) {
      STORE.dispatch(MenuInput.actions.focus(statePath + '.sheriff'));
    }
  }
  ...
  async onSheriffClear_(event) {
    STORE.dispatch(MenuInput.actions.focus(this.statePath + '.sheriff'));
    this.dispatchSources_();
  }
  ...
  async onBugClear_(event) {
    STORE.dispatch(MenuInput.actions.focus(this.statePath + '.bug'));
    this.dispatchSources_();
  }
  ...
  async onReportClear_(event) {
    STORE.dispatch(MenuInput.actions.focus(this.statePath + '.report'));
    this.dispatchSources_();
  }
