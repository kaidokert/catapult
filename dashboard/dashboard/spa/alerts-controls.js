  ...
  render() {
    return html`
      ...
      <div id="bug-container"
          hidden="${!this.showMenuInput_(this.showEmptyInputs, this.bug,
            this.sheriff, this.report, this.minRevision, this.maxRevision)}">
        <menu-input
            id="bug"
      ...
      <div id="report-container"
        ...
        <menu-input
          ...
          <recommended-options slot="top" .state-path="${this.statePath}.report">
          </recommended-options>
        </menu-input>
      </div>

      <div id="min-container"
          hidden="${!this.showInput_(this.showEmptyInputs, this.minRevision,
            this.maxRevision, this.sheriff, this.bug, this.report)}">
        <cp-input
            id="min-revision"
