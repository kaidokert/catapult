...
export default class AlertDetail extends ElementBase {
  ...
  static get template() {
    return html`
      ...
      <flex>
        <div id="left">
          <div>[[startRevision]]-[[endRevision]]</div>
          <div>
  ...
  stateChanged(rootState) {
    ...
    const green = 'var(--improvement-color, green)';
    const grey = 'var(--neutral-color-dark, grey)';
    const red = 'var(--error-color, red)';
    this.style.borderColor = (this.improvement ? green :
      (this.bugId ? grey : red));
  }
