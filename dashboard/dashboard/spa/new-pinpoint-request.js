...
export default class NewPinpointRequest extends RequestBase {
  constructor(options) {
    ...
    this.body_.set('test_case', options.test_case);
    this.body_.set('statistic', options.statistic);
    this.body_.set('mode', options.mode);
    this.body_.set('bug', options.bug);
    this.body_.set('patch', options.patch);
    this.body_.set('start_revision', options.start_revision);
    this.body_.set('end_revision', options.end_revision);
  }
