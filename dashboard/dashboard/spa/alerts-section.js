...
export default class AlertsSection extends ElementBase {
  ...
  render() {
    ...
    const canTriage = (
      window.IS_PRODUCTION && (selectedAlerts.length > 0) && !anyTriaged);
    const canUnassignAlerts = window.IS_PRODUCTION && anyTriaged;
    ...
    return html`
      ...
      ${(this.alertGroups && this.alertGroups.length) ? html`
        <div id="triage_controls"
          ...
          <span style="position: relative;">
            ...
            <triage-new
                tabindex="0"
                state-path="${this.statePath}.newBug"
          ...
          <span style="position: relative;">
            ...
            <triage-existing
                tabindex="0"
                state-path="${this.statePath}.existingBug"
      ...
      <chart-compound
          id="preview"
          hidden="${allTriaged}"
          state-path="${this.statePath}.preview"
          linked-state-path="${this.linkedStatePath}"
  ...
  allTriaged_() {
    ...
    if (this.showingTriaged) return alertGroups.length === 0;
