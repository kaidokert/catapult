...
tr.exportTo('cp', () => {
  ...
  cp.sectionReducer('alerts-section.toggleSourceGroupExpanded', (state, action, section) => {
    return {
      source: {
        ...section.source,
        options: cp.DropdownInput.toggleGroupExpanded(section.source.options, action.path),
      },
    };
  });
