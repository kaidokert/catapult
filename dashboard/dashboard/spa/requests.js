...
tr.exportTo('cp', () => {
  ...
  class ReleasingSourcesRequest extends RequestBase {
    get url_() {
      return '/api/releasing_sources';
    }
  ...
  class ReleasingReportRequest extends RequestBase {
    constructor(options) {
      super(options);
    ...
    get url_() {
      return `/api/releasing_report/${this.source_}/${this.milestone_}`;
    }
  ...
  return {
    ...
    ExistingBugRequest,
    NewBugRequest,
    ReleasingReportRequest,
    ReleasingSourcesRequest,
    RequestBase,
    SessionIdRequest,
    SessionStateRequest,
    TestSuitesRequest,
