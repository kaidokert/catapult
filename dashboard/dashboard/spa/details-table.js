...
export default class DetailsTable extends ElementBase {
  ...
  static buildCellRevisions(cell, reference, links) {
  ...
  static buildCellBisect(cell, alerts, lineDescriptor) {
  ...
  static buildCell(
    ...
    const links = new Map();
    DetailsTable.buildCellRevisions(cell, reference, links);
    ...
    const bisectCell = DetailsTable.buildCellBisect(cell, alerts, lineDescriptor);
