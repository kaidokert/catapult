...
} from '/@polymer/polymer/mixins/gesture-event-listeners.js';
...
import PolymerSvgTemplate from
  '/polymer-svg-template/polymer-svg-template.html';
...
class ChartBase extends GestureEventListeners(ElementBase) {
  static get template() {
    return TEMPLATE;
  }
