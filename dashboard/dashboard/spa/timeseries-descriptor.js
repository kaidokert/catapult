  ...
  render() {
    return html`
      <div id="row">
        <div>
          <menu-input
              state-path="${this.statePath}.suite"
        ...
        <div>
          <menu-input
              state-path="${this.statePath}.measurement"
              @option-select="${this.onMeasurementSelect_}">
            <div slot="top">
              <recommended-options state-path="${this.statePath}.measurement">
              </recommended-options>
              <memory-components state-path="${this.statePath}.measurement">
              </memory-components>
            </div>
          </menu-input>
        ...
        <div>
          <menu-input
              state-path="${this.statePath}.bot"
              @option-select="${this.onBotSelect_}">
            <recommended-options slot="top" state-path="${this.statePath}.bot">
            </recommended-options>
          </menu-input>

          <div class="error" visible="${this.bot.selectedOptions.length === 0}">
            At least one required
          </div>
        ...
        <div>
          <menu-input
              state-path="${this.statePath}.case"
              @option-select="${this.onCaseSelect_}">
            <recommended-options slot="top" state-path="${this.statePath}.case">
            </recommended-options>

            <tag-filter slot="left" state-path="${this.statePath}.case">
            </tag-filter>
          </menu-input>
