...
class Timeseries2Test(testing_common.TestCase):
  ...
  # TODO test cache-control public
  # TODO test cache-control private test
  # TODO test cache-control private alert
  # TODO test cache-control private histogram
  # TODO test cache-control private diagnostic
