...
REVISIONS_BY_INTERNAL_BOT_HASH = {
    '2ce3348d4304644ad7b9407f217aa56c9afd37fbaba775d4e0bb3ad54f455328': {
        540302: 1519967271,
        543346: 1521142039,
    },
...
def GetRow(test, revision):
  ...
  if bot_revision:
    return utils.GetRowKey(test.key, bot_revision).get()
