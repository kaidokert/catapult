...
class DescribeHandler(api_request_handler.ApiRequestHandler):
  ...
  def _FetchTestKeys(suite_name, test_part1_name=None):
    query = graph_data.TestMetadata.query().filter(
        ...
        graph_data.TestMetadata.deprecated == False,
        graph_data.TestMetadata.test_part2_name != 'ref',
        graph_data.TestMetadata.test_part3_name != 'ref',
        graph_data.TestMetadata.test_part4_name != 'ref',
        graph_data.TestMetadata.test_part5_name != 'ref')
    if test_part1_name:
      query = query.filter(
