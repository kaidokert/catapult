...
class ProcessAlertsTest(testing_common.TestCase):
  ...
  def testProcessTest_CreatesAnAnomaly(self):
    ...
    self.assertEqual(241538, new_anomalies[0].start_revision)
  ...
  def testProcessTest_RefineAnomalyPlacement_OffByOneBefore(self):
    ...
    sample_data = [
        ...
        (729687, 486.1097),
        (729706, 478.036),
        (729730, 480.4222),  # This is the original culprit.
        (729764, 421.0342),  # This is a culprit we can use.
        (729795, 428.0284),
        (729846, 433.8261),
        (729883, 429.49),
        (729920, 436.3342),
    ...
    self.assertEqual(729765, new_anomalies[0].start_revision)
    self.assertEqual(729795, new_anomalies[0].end_revision)
