...
# crbug/1339701
# This is a hack to force ndb pickle to use a lower version of protocol when
# creating jobs.
# This workaround assumes ndb will not set the at any point. Otherwise, it will
# break that the pinpoint service running in Python 2 runtime can no longer load
# the jobs created in Python 3 runtime.
