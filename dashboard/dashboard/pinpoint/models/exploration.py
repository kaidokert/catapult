...
subscripts in the rang 0..N as shown below:
...
def Speculate(changes, change_detected, on_unknown, midpoint, levels=2):
  ...
  - on_unknown: a function invoked when change_detected returns None (or is
    inconclusive) taking both changes.
  - midpoint: a function invoked returning the midpoint between two changes.
