...
"""Model for storing information to look up cas.

An cas reference is a way to refer build in cas
"""
...
# TODO(fancl): Turn this into a Dataflow job instead.
def DeleteExpiredCASReference(start_cursor=None):
  expire_time = datetime.datetime.utcnow() - CAS_EXPIRY_DURATION
  q = CASReference.query()
  q = q.filter(CASReference.created < expire_time)
  ...
  if more and next_cursor:
    deferred.defer(DeleteExpiredCASReference, next_cursor)
