...
class ExploreTest(unittest.TestCase):
  ...
  def testPending(self):
    state = job_state.JobState([_QuestStub(execution_stub.ExecutionSpin)],
  ...
  def testSame(self):
    state = job_state.JobState([_QuestStub(execution_stub.ExecutionPass)],
...
class ScheduleWorkTest(unittest.TestCase):
  ...
  def testWorkLeft(self):
    q = _QuestStub(execution_stub.ExecutionPass, execution_stub.ExecutionSpin)
  ...
  def testAllAttemptsFail(self):
    q = _QuestStub(execution_stub.ExecutionFail, execution_stub.ExecutionFail,
                   execution_stub.ExecutionFail2)
    state = job_state.JobState([q])
    state.AddChange('change')
