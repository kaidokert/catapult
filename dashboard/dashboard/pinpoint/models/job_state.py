  ...
  def _Compare(self, change_a, change_b):
    ...
    for quest in self._quests:
      ...
      if exceptions_a and exceptions_b:
        ...
        logging.debug('BisectDebug: Functional Comparing exceptions: %s, %s', exceptions_a, exceptions_b)
      ...
      if all_a_values and all_b_values:
        ...
        logging.debug('BisectDebug: Comparing values: %s, %s', all_a_values, all_b_values)
        comparison, _, _, _ = compare.Compare(
            all_a_values,
            all_b_values,
            sample_count,
