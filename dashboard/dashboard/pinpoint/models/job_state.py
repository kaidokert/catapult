  ...
  def Explore(self):
    ...
    def Speculate(change_a_index, change_b_index):
      ...
      if comparison == compare.DIFFERENT:
        ...
        accumulated_changes.add(midpoint_0)
        if midpoint_0_left not in accumulated_changes:
          accumulated_changes.add(midpoint_0_left)
        if midpoint_0_right not in accumulated_changes:
          accumulated_changes.add(midpoint_0_right)
