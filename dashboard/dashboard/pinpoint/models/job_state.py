...
class JobState:
  ...
  def Explore(self, benchmark_arguments=None):
    ...
    def DetectChange(change_a, change_b, benchmark_arguments=None):
  ...
  def _Compare(self, change_a, change_b, benchmark_arguments=None):
