...
class GenerateResults2Test(testing_common.TestCase):
  ...
  def testTypeDispatch_PushBQ(self,
    ...
    patch_b = patch.GerritPatch("fakePatchServer", "fakePatchNo", "fakePatchRev")
