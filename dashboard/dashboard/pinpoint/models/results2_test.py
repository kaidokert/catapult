...
class GenerateResults2Test(testing_common.TestCase):
  ...
  def testTypeDispatch_PushBQ(self, mock_swarming, mock_json, mock_render,
    ...
    fcp_histogram = histogram_module.Histogram('timeToFirstContentfulPaint', 'count')
    fcp_histogram.AddSample(11)
    cls_histogram = histogram_module.Histogram('overallCumulativeLayoutShift', 'count')
    ...
    results2.GenerateResults2(job)
    mock_bqinsert.assert_called_once_with('chromeperf', 'pinpoint_export_test', 'pinpoint_results', expected_rows)
