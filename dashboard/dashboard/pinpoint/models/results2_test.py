  ...
  def testTypeDispatch_PushBQ_CH_Jetstream2(self, mock_commit_info,
    ...
    expected_rows = [{
        ...
        'measures': {
            ...
            'jetstream2': {
                'Score': 1,
                '3d-cube-SP.Average': 2,
                '3d-raytrace-SP.Average': 3,
                'Air.Average': 4,
                'Babylon.Average': 5,
                'Basic.Average': 6,
                'Box2D.Average': 7,
                'FlightPlanner.Average': 8,
                'HashSet-wasm.Runtime': 9,
                'ML.Average': 10,
                'OfflineAssembler.Average': 11,
                'UniPoker.Average': 12,
                'WSL.MainRun': 13,
                'acorn-wtb.Average': 14,
                'ai-astar.Average': 15,
                'async-fs.Average': 16,
                'babylon-wtb.Average': 17,
                'base64-SP.Average': 18,
                'bomb-workers.Average': 19,
                'cdjs.Average': 20,
                'chai-wtb.Average': 21,
                'coffeescript-wtb.Average': 22,
                'crypto-aes-SP.Average': 23,
                'crypto-md5-SP.Average': 24,
                'crypto-shal-SP.Average': 25,
                'crypto.Average': 26,
                'date-format-tofte-SP.Average': 27,
                'date-format-xparb-SP.Average': 28,
                'delta-blue.Average': 29,
                'earley-boyer.Average': 30,
                'espree-wtb.Average': 31,
                'first-inspector-code-load.Average': 32,
                'float-mm_c.Average': 33,
                'gaussian-blur.Average': 34,
                'gbemu.Average': 35,
                'gcc-loops-wasm.Runtime':36,
                'hash-map.Average': 37,
                'jshint-wtb.Average': 38,
                'json-parse-inspector.Average': 39,
                'json-stringify-inspector.Average': 40,
                'lebab-wtb.Average': 41,
                'mandreel.Average': 42,
                'multi-inspector-code-load.Average': 43,
                'n-body-SP.Average': 44,
                'navier-stokes.Average': 45,
                'octane-code-load.Average': 46,
                'octane-zlib.Average': 47,
                'pdfjs.Average': 48,
                'prepack-wtb.Average': 49,
                'quicksort-wasm.Runtime': 50,
                'raytrace.Average': 51,
                'regex-dna-SP.Average': 52,
                'regexp.Average': 53,
                'richards-wasm.Runtime': 54,
                'richards.Average': 55,
                'segmentation.Average': 56,
                'splay.Average': 57,
                'stanford-crypto-aes.Average': 58,
                'stanford-crypto-pbkdf2.Average': 59,
                'stanford-crypto-sha256.Average': 60,
                'string-unpack-code-SP.Average': 61,
                'tagcloud-SP.Average': 62,
                'tsf-wasm.Runtime': 63,
                'typescript.Average': 64,
                'uglify-js-wtb.Average': 65
            },
        },
        'run_id': 'fake_job_id'
    }, {
