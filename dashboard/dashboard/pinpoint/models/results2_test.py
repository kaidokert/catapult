...
class GenerateResults2Test(testing_common.TestCase):
  ...
  def testTypeDispatch_PushBQ_CWV(self, mock_commit_info, mock_swarming,
    ...
    expected_histogram_set = histogram_set.HistogramSet([
        createHistogram('largestContentfulPaint', 42),
        createHistogram('timeToFirstContentfulPaint', 11),
        createHistogram('overallCumulativeLayoutShift', 22),
        createHistogram('totalBlockingTime', 33),
        createHistogram('someUselessMetric', 42)
    ])
    job = setupBQTest(mock_commit_info, mock_swarming, mock_render, mock_json,
  ...
  def testTypeDispatch_PushBQ_Speedometer2(self, mock_commit_info,
    ...
    expected_histogram_set = histogram_set.HistogramSet([
        createHistogram('Angular2-TypeScript-TodoMVC', 1),
        createHistogram('AngularJS-TodoMVC', 2),
        createHistogram('BackboneJS-TodoMVC', 3),
        createHistogram('Elm-TodoMVC', 4),
        createHistogram('EmberJS-Debug-TodoMVC', 5),
        createHistogram('EmberJS-TodoMVC', 6),
        createHistogram('Flight-TodoMVC', 7),
        createHistogram('Inferno-TodoMVC', 8),
        createHistogram('jQuery-TodoMVC', 9),
        createHistogram('Preact-TodoMVC', 10),
        createHistogram('React-Redux-TodoMVC', 11),
        createHistogram('React-TodoMVC', 12),
        createHistogram('Vanilla-ES2015-Babel-Webpack-TodoMVC', 13),
        createHistogram('Vanilla-ES2015-TodoMVC', 14),
        createHistogram('VanillaJS-TodoMVC', 15),
        createHistogram('VueJS-TodoMVC', 16)
    ])
    job = setupBQTest(mock_commit_info, mock_swarming, mock_render, mock_json,
                      expected_histogram_set)
    ...
    expected_rows = [{
        ...
        'measures': {
            'core_web_vitals': {},
            'speedometer2': {
                'Angular2-TypeScript-TodoMVC': 1,
                'AngularJS-TodoMVC': 2,
                'BackboneJS-TodoMVC': 3,
                'Elm-TodoMVC': 4,
                'EmberJS-Debug-TodoMVC': 5,
                'EmberJS-TodoMVC': 6,
                'Flight-TodoMVC': 7,
                'Inferno-TodoMVC': 8,
                'jQuery-TodoMVC': 9,
                'Preact-TodoMVC': 10,
                'React-Redux-TodoMVC': 11,
                'React-TodoMVC': 12,
                'Vanilla-ES2015-Babel-Webpack-TodoMVC': 13,
                'Vanilla-ES2015-TodoMVC': 14,
                'VanillaJS-TodoMVC': 15,
                'VueJS-TodoMVC': 16
            }
        },
        'run_id': 'fake_job_id'
...
def createHistogram(name, val):
  h = histogram_module.Histogram(name, 'count')
  h.AddSample(val)
  return h


def setupBQTest(mock_commit_info, mock_swarming, mock_render, mock_json,
                expected_histogram_set):
