...
class _RunTestExecution(execution_module.Execution):
  ...
  def _Poll(self):
    ...
    self._ReportSwarmingRunTime(result)
  ...
  @staticmethod
  def _ReportSwarmingRunTime(result):
    ...
    Including:
      ...
      os: the detailed os version of the bot.
      bot_id: bot id.
      pinpoint job type: try or bisect. Expecting longer wait on try jobs
    ...
    if created_ts and started_ts and completed_ts:
      ...
      bot_os, pinpoint_job_type = None, None
      ...
      cloud_metric.PublishPinpointSwarmingMetric(
          task_id=result.get('task_id'),
          pinpoint_job_type=pinpoint_job_type,
          bot_id=result.get('bot_id'),
          bot_os=bot_os,
          pending_time=str(pending_time),
