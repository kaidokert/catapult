...
class FindIsolateEvaluatorTest(test.TestCase):
  ...
  def testInitiate_ScheduleBuild(self):
    self.skipTest('Not implemented yet.')

  def testUpdate_BuildSuccessful(self):
    self.skipTest('Not implemented yet.')

  def testUpdate_BuildFailed_ScheduleRetry(self):
    self.skipTest('Not implemented yet.')

  def testUpdate_BuildFailed_HardFailure(self):
    self.skipTest('Not implemented yet.')
