      ...
      if bug_id == 123456:
        ...
        return {
            ...
            'id':
                123457,
            'title':
                '[[b/12345 fix a bug] Sandwich Verification Test Speedometer2]: 2 regressions in speedometer2',
        }
      elif bug_id == 123458:
        return {
            'projectId':
        ...
        return {
            ...
            'id':
                123459,
            'title':
                '[Sandwich Verification Test Speedometer2][b/12345 fix a bug]: 2 regressions in speedometer2',
        }
      elif bug_id == 123460:
        return {
            'projectId':
