...
_METRIC_MAP = {
  ...
  "timeToFirstContentfulPaint": ("core_web_vitals", "timeToFirstContentfulPaint"),
  "overallCumulativeLayoutShift": ("core_web_vitals", "overallCumulativeLayoutShift"),
  "totalBlockingTime": ("core_web_vitals", "totalBlockingTime"),

  # Speedometer2
  "Angular2-TypeScript-TodoMVC": ("speedometer2", "Angular2-TypeScript-TodoMVC"),
  ...
  "Vanilla-ES2015-Babel-Webpack-TodoMVC": ("speedometer2", "Vanilla-ES2015-Babel-Webpack-TodoMVC"),
