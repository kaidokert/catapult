...
class Change(
  ...
  def Midpoint(cls, change_a, change_b):
    ...
    * The second pass takes the midpoint of every matched pair of Commits,
    ...
    logging.Debug("b/343229141 - commits_a vs commits_b after expandDeps: %s vs %s", commits_a, commits_b)
...
def _ExpandDepsToMatchRepositories(commits_a, commits_b):
  ...
  """
  logging.Debug("b/343229141 - expandDEPS of commits_a vs commits_b: %s vs %s", commits_a, commits_b)
...
def _FindMidpoints(commits_a, commits_b):
  ...
  logging.Debug("b/343229141 - findMidpoints of commits_a vs commits_b: %s vs %s", commits_a, commits_b)
  for commit_a, commit_b in zip_longest(commits_a, commits_b):
    ...
    if commit_a == commit_midpoint and commit_midpoint != commit_b:
      ...
      logging.Debug("b/343229141 - findMidpoint: apply deps changes deps_a vs deps_b %s vs %s", deps_a, deps_b)
