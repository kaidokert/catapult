...
def HighThreshold(mode, magnitude, sample_size):
  ...
  for mag in sorted(thresholds.keys()):
    if not magnitude_index:
      magnitude_index = mag
    if abs(magnitude) >= mag:
      magnitude_index = mag
...
_HIGH_THRESHOLDS_FUNCTIONAL = {
    ...
    0.3: (1.000, 1.000, 1.000, 1.000, 1.000, 1.000, 1.000, 1.000, 1.000, 1.000,
     ...
     .0118, .0119, .0120, .0063),
    # Magnitude 0.4
    0.4: (1.000, 1.000, 1.000, 1.000, 1.000, 1.000, 1.000, 1.000, 1.000, .3682,
     .3634, .3594, .3560, .1647, .1642, .1638, .1634, .0800, .0802, .0804,
     .0806, .0404, .0406, .0409, .0207, .0209, .0210, .0212, .0108, .0109,
     .0110, .0057),
    # Magnitude 0.5
    0.5: (1.000, 1.000, 1.000, 1.000, 1.000, 1.000, .3914, .3816, .3741, .3682,
     .1666, .1659, .1652, .0789, .0793, .0796, .0388, .0392, .0192, .0195,
     .0198, .0098),
    # Magnitude 0.6
    0.6: (1.000, 1.000, 1.000, 1.000, 1.000, .4047, .3914, .1700, .1686, .1675,
     .0775, .0781, .0366, .0373, .0175, .0180, .0185, .0088),
    # Magnitude 0.7
    0.7: (1.000, 1.000, 1.000, .4533, .4238, .4047, .1717, .1700, .0758, .0768,
     .0348, .0156, .0163, .0074),
    # Magnitude 0.8
    0.8: (1.000, 1.000, .5050, .4533, .1771, .1740, .0730, .0746, .0322, .0137,
     .0147, .0064),
    # Magnitude 0.9
    0.9: (1.000, .6171, .5050, .1814, .0668, .0706, .0279, .0110, .0043),
    # Magnitude 1.0
    1.0: (1.000, .1940, .0469, .0132, .0040),
}
