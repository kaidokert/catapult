  ...
  def AsDict(self):
    ...
    for change in self._changes:
      ...
      for quest in self._quests:
        quest_result_values = []
        for execution in executions[quest]:
          quest_result_values.append(execution.result_values)
...
def _Flatten(iterable):
  return (value for sublist in iterable for value in sublist)
