...
class SkiaPerfUploadTest(testing_common.TestCase):
  ...
  def testUploadRowInternal(self, mock_gcs):
    ...
    skia_data_expected = {
        ...
        'links': {
            'Build Page': '[Build Status](https://xxx)',
            'Test stdio': '[Buildbot stdio](http://xxx)',
            'Chromium Commit Position': 668729,
            'V8 Git Hash': '0027447130c41b7724f4babf2d3f340a963b5e42',
            'WebRTC Git Hash': 'a7acc4dd8d303310fb1bd2cfafbc032f308b1fbc'
        }
    }
    ...
    self.assertTrue(
        'ChromiumAndroid/android-cronet-arm-rel/resource_sizes (CronetSample.apk)/InstallSize/APK size/2424228/'
        in mock_args[0])
