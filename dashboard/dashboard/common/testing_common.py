...
class TestCase(unittest.TestCase):
  ...
  def setUp(self):
    ...
    SetIsInternalUser(GOOGLER_USER, True)
    SetIsInternalUser(NON_GOOGLE_USER, False)
    self.testapp = None
  ...
  def SetCurrentUserOAuth(self, user):
    patch = mock.patch.object(oauth, 'get_current_user',
  ...
  def _PatchIsInternalUser(self):
    ...
    """
    def IsInternalUser():
      return bool(utils.GetCachedIsInternalUser(utils.GetCurrentUser()))
