...
<<<<<<< PATCH SET (b9aeb5 Add API metrics (call count, failure, latency) to Pinpoint s)
...
=======
  ...
  # such as "my-project".
  series.resource.labels["project_id"] = project_id
>>>>>>> BASE      (821d20 Stop using overriden_anomaly_config.max_window_size on anoma)
...
class APIMetricLogger:
  ...
  def __exit__(self, exception_type, exception_value, execution_traceback):
    if exception_type is None:
      ...
      label_dict = {API_NAME: self._api_name, RUN_TIME: self.seconds,
