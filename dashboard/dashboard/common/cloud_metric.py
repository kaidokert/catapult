...
class APIMetricLogger:
  ...
  def __enter__(self):
    ...
    PublishTSCloudMetric(self._service_name, API_METRIC_TYPE, label_dict, app_identity.get_application_id())
  ...
  def __exit__(self, type, value, traceback):
    if type is None:
      ...
      PublishTSCloudMetric(self._service_name, API_METRIC_TYPE, label_dict, app_identity.get_application_id(), self.seconds)
    else:
      # has exception
