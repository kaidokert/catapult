...
def PublishPinpointJobDetailMetrics(project_id,
  ...
  _PublishTSCloudMetric(project_id, "pinpoint",
                        "pinpoint/job/change_count_per_job",
                        label_dict, change_count)
  _PublishTSCloudMetric(project_id, "pinpoint",
                        "pinpoint/job/attempt_count_per_job",
                        label_dict, attempt_count)
  _PublishTSCloudMetric(project_id, "pinpoint",
                        "pinpoint/job/difference_count_per_job",
                        label_dict, difference_count)
