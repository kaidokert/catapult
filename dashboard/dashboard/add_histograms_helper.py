...
"""Helper for adding new histograms to the dashboard."""
...
TASK_RETRY_LIMIT = 4
ZLIB_BUFFER_SIZE = 4096


def CreateUploadCompletionToken(temporary_staging_file_path=None):
  token_info = {
...
class DecompressFileWrapper(object):
  ...
  def __init__(self, source_file, buffer_size=ZLIB_BUFFER_SIZE):
...
def LoadHistogramList(input_file):
