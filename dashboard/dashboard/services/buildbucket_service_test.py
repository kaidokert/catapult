...
class BuildbucketServiceTest(unittest.TestCase):
  ...
  def testPutV2(self):
    ...
    expected_body = {
        ...
        'tags': [{
            'key': 'buildset',
            'value': 'commit/gitiles/host/project/name/+/' + mock_hash
        }, {
            'key': 'buildset',
            'value': 'patch/gerrit/host/7654321/8'
        }, {
            'key': 'buildset',
            'value': 'patch/gerrit/host/8765432/9'
        }],
    ...
    tags = [gitile_buildset, patch_buildset, patch_buildset_2]
