...
class DecompressFileWrapper(object):
  ...
  """Docstring for DecompressFileWrapper(object):. """
  ...
  def post(self):
    ...
    try:
      ...
      try:
        ...
        decompressing_file = DecompressFileWrapper(gcs_file)

        histogram_dicts = _LoadHistogramList(decompressing_file)

        decompressing_file.close()
        gcs_file.close()
