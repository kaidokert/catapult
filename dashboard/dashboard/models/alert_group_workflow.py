...
class AlertGroupWorkflow:
  ...
  def Process(self, update=None):
    ...
    # This doesn't work due to `AttributeError: 'Key' object has no attribute 'benchmark_name'` in _CheckSandwichAllowlist:
    # elif len(self._CheckSandwichAllowlist(group.anomalies)) > 0:  and not group.verified:
    elif self._TryVerifyRegression(update):
