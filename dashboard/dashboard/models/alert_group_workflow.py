...
class AlertGroupWorkflow(object):
  ...
  def Process(self, update=None):
    ...
    self._PreproccessedAnomalies(update.anomalies)
  ...
  def _PreproccessedAnomalies(self, anomalies):
    """Preproccess all anomalies.

    It should be called only once at the begining of process
    """
