...
class AlertGroupWorkflow(object):
  ...
  def Process(self, update=None):
    ...
    # TODO(crbug.com/1240370): understand why Datastore query may return empty anomalies list.
    if len(update.anomalies) == 0 and len(self._group.anomalies) != 0:
      logging.warning('No anomailes detected. Skipping this run.')
