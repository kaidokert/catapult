...
class AlertGroupWorkflowTest(testing_common.TestCase):
  ...
  def testAutoMerge_SucessfulMerge_DuplicateGroupRun(self):
    self._sheriff_config.patterns = {
        '*': [
            subscription.Subscription(
                name='sheriff',
  ...
  def testAutoMerge_AutoMergeNotOptIn_DuplicateGroupRun(self):
    self._sheriff_config.patterns = {
        '*': [
            subscription.Subscription(
                name='sheriff',
    ...
    self.assertEqual(group.get().canonical_group, None)
    self.assertEqual(group.get().status, alert_group.AlertGroup.Status.closed)

  def testAutoMerge_NoCanonicalIssue_DuplicateGroupRun(self):
    self._sheriff_config.patterns = {
        '*': [
            subscription.Subscription(
                name='sheriff',
  ...
  def testAutoMerge_SucessfulMerge_AutoMergeForOneAnomaly_DuplicateGroupRun(self):
    self._sheriff_config.patterns = {
        '*auto_merge*': [
            subscription.Subscription(
                name='sheriff',
  ...
  def testAutoMerge_SucessfulMerge_NoNewAnomalies_DuplicateGroupRun(self):
    self._sheriff_config.patterns = {
        '*': [
            subscription.Subscription(
                name='sheriff',
