...
class AlertGroupWorkflowTest(testing_common.TestCase):
  ...
  def testSandwich_Allowlist_enabled(self):
    ...
    for test_case in test_cases:
      anomalies.append(
          self._AddAnomaly(test=test_case, ownership={'component':'anomaly>should>not>set>component'}))
  ...
  def testSandwich_TryVerifyRegression_sandwiched_SUCCEEDED_doBisect(self):
    ...
    anomalies = [
        self._AddAnomaly(test=test_name, statistic="made up"),
        self._AddAnomaly(test=test_name, statistic="also made up", ownership={'component':'anomaly>should>not>set>component'})
    ]
    ...
    self.assertNotIn('anomaly>should>not>set>component', self._issue_tracker.issue.get('components'))
