...
class AlertGroupWorkflowTest(testing_common.TestCase):
  ...
  def testPrepareGroupUpdate_FailedToFindAnomalies(self):
    ...
    query_mock.fetch = mock.MagicMock(return_value=None)
    anomaly.Anomaly.query = query_mock
    ...
    self.assertIsNone(update.canonical_group)
    query_mock.assert_called_once_with(anomaly.Anomaly.groups.IN([group.key]))
