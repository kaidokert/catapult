...
class AlertGroupWorkflowTest(testing_common.TestCase):
  ...
  def testPrepareGroupUpdate_AlertGroupBugBackwardsCompatiblity(self):
    ...
    print('---- _ug %s Backwards bug %s' % (str(group_entity.bug), str(group_entity.bug_backwards_compatible)))
    ...
    print('2--- _ug %s Backwards bug %s' % (str(group_entity.bug), str(group_entity.bug_backwards_compatible)))
