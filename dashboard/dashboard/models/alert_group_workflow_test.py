...
class AlertGroupWorkflowTest(testing_common.TestCase):
  ...
  def testPrepareGroupUpdate_AlertGroupBugBackwardsCompatiblity(self):
    ...
    group_entity._properties['bug'] = ndb.LocalStructuredProperty(alert_group.BugInfo)
    print('2--- Bug %s' % str(group_entity._properties))
    ...
    print('3--- Bug %s' % str(group_entity._properties))

    group_entity.put()

    group_entity = group.get()

    print('4--- Bug %s' % str(group_entity._properties))
    print('5--- Bug %s' % str(group_entity.bug))
