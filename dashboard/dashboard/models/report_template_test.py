...
class ReportTemplateTest(testing_common.TestCase):
  ...
  def testPutTemplate_External(self):
    ...
    template = ndb.Key('ReportTemplate', 'testPutTemplate_External').get()
    self.assertEqual('foo', template.name)
