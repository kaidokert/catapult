...
class GroupReportTest(GroupReportTestBase):
  ...
  def testTriageAltertsGroup(self, mock_get_sheriff_client):
    ...
    logging.debug('Rendered:\n%s', self.fake_issue_tracker.new_bug_kwargs['comment'])
    self.assertRegex(self.fake_issue_tracker.new_bug_kwargs['comment'],
  ...
  def testAddAlertsAfterTriage(self, mock_get_sheriff_client):
    ...
    self.assertRegex(self.fake_issue_tracker.add_comment_kwargs['components'],
