...
def WriteToPartitionedBigQuery(table_name,
  ...
  Like WriteToBigQuery, if table_name can either be a str or a callable.  When
  it is a callable it will be called with each element and the return value is
  used as the table name for that element.
  """
