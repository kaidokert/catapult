...
r"""Export chromeperf dashboard data to BigQuery with Beam & Cloud Dataflow.
...
from apache_beam.transforms.core import FlatMap, ParDo
...
# TODO(abennetts): create manifests so that this can be imported from
# split_by_timestamp rather than copy-pasted.
class ReadTimestampRangeFromDatastore(beam.PTransform):
  """A ReadFromDatastore alternative for fetching entities in a time range."""
