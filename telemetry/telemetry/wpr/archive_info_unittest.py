...
class WprArchiveInfoTest(unittest.TestCase):
  ...
  def testAddRecordedStoriesDefault(self, hash_mock):
    test_archive_info = self.createArchiveInfo()
    self.assertWprFileDoesNotExist('data_abcdef0006.wprgo')
    ...
    expected_archive_contents['archives'] = {
        ...
        page2.name: {
            _DEFAULT_PLATFORM: 'data_abcdef0006.wprgo'
        },
        page3.name: {
            _DEFAULT_PLATFORM: 'data_abcdef0006.wprgo',
            'linux': recording4,
    ...
    self.assertWprFileDoesExist('data_abcdef0006.wprgo')
  ...
  def testAddRecordedStoriesNewPage(self):
    test_archive_info = self.createArchiveInfo()
    self.assertWprFileDoesNotExist('data_abcdef0006.wprgo')
    self.assertWprFileDoesNotExist('data_abcdef0007.wprgo')
    new_temp_recording = os.path.join(self.tmp_dir, 'recording.wprgo')
    ...
    expected_archive_contents['archives'] = {
        ...
        pageNew2.name: {
            _DEFAULT_PLATFORM: 'data_abcdef0007.wprgo',
            'android': 'data_abcdef0007.wprgo'
        }
    }
    ...
    with open(self.story_set_archive_info_file, 'rU') as f:
      for line in f:
        self.assertFalse(line.rstrip('\n').endswith(' '))
    self.assertWprFileDoesExist('data_abcdef0006.wprgo')
    self.assertWprFileDoesExist('data_abcdef0007.wprgo')
