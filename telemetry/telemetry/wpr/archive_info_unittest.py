...
class WprArchiveInfoTest(unittest.TestCase):
  ...
  def testDownloadArchivesIfNeededAllOrOneNeeded(self, get_mock):
    ...
    self.assertItemsEqual(
        ...
        [(os.path.join(self.tmp_dir, recording1), cloud_storage.PUBLIC_BUCKET),
         (os.path.join(self.tmp_dir, recording2), cloud_storage.PUBLIC_BUCKET),
         (os.path.join(self.tmp_dir, recording3), cloud_storage.PUBLIC_BUCKET),
