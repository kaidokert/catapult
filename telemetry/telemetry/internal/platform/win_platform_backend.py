...
class WinPlatformBackend(desktop_platform_backend.DesktopPlatformBackend):
  ...
  def GetScreenResolution(self):
    # 0 - SM_CXSCREEN (width of the screen of the primary display monitor)
    # 1 - SM_CYSCREEN (height of the screen of the primary display monitor)
    ...
    return int(width * scale / 100), int(height * scale / 100)
