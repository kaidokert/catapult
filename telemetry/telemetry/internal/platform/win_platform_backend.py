...
try:
  ...
  logging.warning('Unable to import pywintypes')

try:
  import win32api  # pylint: disable=import-error
except ImportError:
  logging.warning('Unable to import win32api')

try:
  from win32com.shell import shell  # pylint: disable=no-name-in-module
except ImportError:
  logging.warning('Unable to import shell')

try:
  from win32com.shell import shellcon  # pylint: disable=no-name-in-module
except ImportError:
  logging.warning('Unable to import shellcon')

try:
  import win32con  # pylint: disable=import-error
except ImportError:
  logging.warning('Unable to import win32con')

try:
  import win32gui  # pylint: disable=import-error
except ImportError:
  logging.warning('Unable to import win32gui')

try:
  import win32process  # pylint: disable=import-error
except ImportError:
  logging.warning('Unable to import win32process')

try:
  import win32ui  # pylint: disable=import-error
except ImportError:
  logging.warning('Unable to import win32ui')

try:
  import winerror  # pylint: disable=import-error
except ImportError:
  logging.warning('Unable to import winerror')
...
try:
  ...
  logging.warning('Unable to import winreg')

try:
  import win32security  # pylint: disable=import-error
except ImportError:
  logging.warning('Unable to import win32security')
  pywintypes = None
  shell = None
  shellcon = None
  win32api = None
