...
This are written to test the public API of the TracingControllerBackend,
using a mock platform and mock tracing agents.

Integrations tests using a real runnin browser and tracing agents can be found
in tests for the public facing telemetry.core.tracing_controller.
"""
...
class TracingControllerBackendTest(unittest.TestCase):
  def setUp(self):
    ...
    mock.patch(
        'tracing.trace_data.trace_data.TraceDataBuilder',
    ...
    mock.patch(
        'py_trace_event.trace_event.clock_sync',
  ...
  def _SetTracingAgentClasses(self, *agents):
    # Replace contents of the list with the agents given as args.
    self._TRACING_AGENT_CLASSES[:] = agents
