...
class AndroidPlatformBackend(
  ...
  def createSubresourceFilter(self):
    ...
    print self._device.RunShellCommand(['chown', '-R', 'u0_a86:u0_a86', '/data/user/0/org.chromium.chrome/Subresource Filter'])
    print self._device.RunShellCommand(['chown', '-R', 'u0_a86:u0_a86', '/data/data/org.chromium.chrome/Subresource Filter'])
