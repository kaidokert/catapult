...
class StoryRunnerTest(unittest.TestCase):
  ...
  def testRunStorySet(self):
    ...
    test = DummyTest()
    story_runner.Run(test, story_set, None, None,
  ...
  def testRunStoryWithMissingArchiveFile(self):
    ...
    test = DummyTest()
    self.assertRaises(
        story_runner.ArchiveError, story_runner.Run,
  ...
  def testRunStoryWithLongURLPage(self):
    ...
    story_runner.Run(test, story_set, fake_browser, None,
                     self.options.browser_options, self.options, self.results)
  ...
  def testAppCrashExceptionCausesFailure(self):
    ...
    story_runner.Run(DummyTest(), story_set, None, None,
                     self.options.browser_options, self.options, self.results)
  ...
  def testPagesetRepeat(self):
    ...
    results = results_options.CreateResults(
        EmptyMetadataForTest(), self.options)
    story_runner.Run(_Measurement(), story_set, None, None,
  ...
  def testRepeatOnce(self):
    ...
    results = results_options.CreateResults(
        EmptyMetadataForTest(), self.options)
    story_runner.Run(_Measurement(), story_set, fake_browser, None,
                     self.options.browser_options, self.options, results)
    summary = summary_module.Summary(results)
    values = summary.interleaved_computed_per_page_values_and_summaries
