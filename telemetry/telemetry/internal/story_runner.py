...
def RunBenchmark(benchmark, finder_options):
  ...
  with results_options.CreateResults(
    ...
    benchmark_documentation_link = benchmark.GetDocumentationLink()
    ...
    if benchmark_documentation_link:
      results.AddSummaryValue(
          reserved_infos.DOCUMENTATION_LINKS.name, benchmark_documentation_link)
