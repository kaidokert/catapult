...
def RunStorySet(test, story_set, possible_browser, expectations,
  ...
  test - an instance of PageTest class, a test to be run.
  ...
  executions_options - options controlling the execution of benchmark.
...
def SetUpAndRunBenchmark(benchmark_to_run, finder_options):
  story_set, possible_browser = _SetUpBenchmark(
...
def _SetUpBenchmark(benchmark_to_run, finder_options):
  ...
  return (story_set, possible_browser)
...
def RunBenchmark(benchmark, story_set, possible_browser,
  ...
  with results_options.CreateResults(
    ...
    try:
      RunStorySet(pt, story_set, possible_browser, benchmark.expectations,
          browser_options, execution_options, results,
