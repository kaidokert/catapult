...
def _ShouldRunBenchmark(benchmark, possible_browser, finder_options):
  ...
  # If we reach this point we should not run the benchmark. But, for the
  # chartjson format, we still need to print a dict indicating the benchmark
  # name and disabled state.
