...
def RunBenchmark(benchmark, finder_options):
  ...
  with results_options.CreateResults(
    ...
    if not finder_options.skip_typ_expectations_tags_validation:
      logging.warning('If a typ expectation tag generated by Telemetry is not '
                      'declared in expectations.config then an exception will '
                      'be raised.\n Use the '
                      '--skip-typ-expectations-tags-validation argument to '
