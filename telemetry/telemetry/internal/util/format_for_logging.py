...
def TrimAndShellFormat(command):
  """Format a shortened version of the command list input for logging.

  Trim finch and feature flags from a command to reduce its length.
  """
  copied_command = list(command)
  _Trim(copied_command)
  return ShellFormat(command)
