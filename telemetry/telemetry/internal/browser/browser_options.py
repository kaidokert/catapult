...
class BrowserOptions(object):
  ...
  def __init__(self):
    ...
    # Some benchmarks (startup and memory related) need this to get more
    # representative measurements. Only has an effect for page sets based on
    # SharedPageState. New clients should probably define their own shared
    # state and make clear caching decisions themselves.
