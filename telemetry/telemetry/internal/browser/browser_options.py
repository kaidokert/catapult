...
class BrowserOptions(object):
  ...
  def __init__(self):
    ...
    # already exist.
    self.profile_files_to_move = []

    # A list of tuples where the first element is some raw data, and the
    # second argument is a path (relative to the user-data-dir) to copy the
    # data to. Uses recursive directory creation if directories do not already
    # exist.
    self.profile_data_to_copy = []
