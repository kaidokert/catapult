...
class BrowserFinderOptions(optparse.Values):
  ...
  def __init__(self, browser_type=None):
    ...
    self.interval_profiler_options_as_string = ''
  ...
  def CreateParser(self, *args, **kwargs):
    ...
    group.add_option(
        ...
        dest='interval_profiler_options_as_string', type=str, default='',
    ...
    def ParseArgs(args=None):
      ...
      if (len(self.interval_profiling_periods) > 1
        ...
        print 'Cannot provide other periods along with the story_run period.'
        sys.exit(1)
