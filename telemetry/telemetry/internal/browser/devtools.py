...
class DevTools(object):
  ...
  def FirePerformanceMark(self, perf_mark, at_end_of_frame=False):
    """Records a JavaScript performance marker in the DevTools frontend

      Args:
        perf_mark: Name of the performance mark
        at_end_of_frame: If True, the performance mark will not fire until the
            current frame has finished rendering. If False, the performance mark
            fires immediately
    """
