...
class App(object):
  ...
  def GetRecentMinidumpPathWithTimeout(self, timeout_s=15, oldest_ts=None):
    ...
    Args:
      ...
      oldest_ts: The oldest allowable timestamp that a minidump was created at
          for it to be considered fresh enough to return. Defaults to a minute
          from the current time if not set.
