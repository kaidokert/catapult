...
class _DevToolsClientConfig(object):
  def __init__(self, devtools_port, app_backend, browser_target):
    ...
    try:
      ...
      # A more basic exception was raised, e.g. KeyboardInterrupt, should close
      # but also re-raise the exception.
      self.Close()
      raise
  ...
  def _CheckHttpReady(self):
    # TODO: Figure out if this is best practice for checking whether an agent
    # is ready.
