...
class PossibleAndroidBrowser(possible_browser.PossibleBrowser):
  ...
  def Create(self):
    """Launch the browser on the device and return its Browser instance."""
    return self._GetBrowserInstance(existing=False)

  def FindExistingBrowser(self):
    """Find an existing browser and return a Browser instance bound to it."""
  ...
  def _GetBrowserInstance(self, existing=False):
    ...
    # TODO(crbug.com/787834): Move cache clearing to environment set up.
