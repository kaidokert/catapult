...
class PossibleAndroidBrowser(possible_browser.PossibleBrowser):
  ...
  def _SetupProfile(self):
    ...
    # Set up the profile before copying it over to the device. The directory on
    # the host will be setup by copying over profile files from an input
    # profile_dir, and adding files from profile_files_to_copy.
    #
    ...
    if self._browser_options.profile_dir:
      ...
      os.rmdir(host_profile)
      shutil.copytree(self._browser_options.profile_dir, host_profile)
