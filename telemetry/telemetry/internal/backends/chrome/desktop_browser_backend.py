...
from telemetry.internal.backends.chrome import crashpad_breakpad_minidump_finder
...
class DesktopBrowserBackend(chrome_browser_backend.ChromeBrowserBackend):
  ...
  def Start(self, startup_args):
    ...
    self._dump_finder = (
        crashpad_breakpad_minidump_finder.CrashpadBreakpadMinidumpFinder(
            self.browser.platform.GetOSName(),
            self.browser.platform.GetArchName()))
    self._dump_symbolizer = (
        desktop_minidump_symbolizer.DesktopMinidumpSymbolizer(
            self.browser.platform.GetOSName(),
            self.browser.platform.GetArchName(),
  ...
  def _GetStackFromMinidump(self, minidump):
    return self._dump_symbolizer.SymbolizeMinidump(minidump)
