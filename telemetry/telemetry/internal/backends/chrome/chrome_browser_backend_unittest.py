  ...
  def testFeaturesMerged(self):
    ...
    for arg in startup_args:
      if arg.startswith('--disable-features='):
        ...
        self.assertEqual(3, len(split_arg))
        self.assertTrue('Feature1' in split_arg)
        self.assertTrue('Feature2' in split_arg)
        self.assertTrue('Feature3' in split_arg)
        disable_count += 1
      elif arg.startswith('--enable-features='):
        split_arg = arg.split('=', 1)[1].split(',')
        self.assertEqual(3, len(split_arg))
        self.assertTrue('Feature4' in split_arg)
        self.assertTrue('Feature5' in split_arg)
        self.assertTrue('Feature6' in split_arg)
        enable_count += 1
