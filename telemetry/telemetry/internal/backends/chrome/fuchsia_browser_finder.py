...
try:
  ...
  _FUCHSIA_IMPORT_SUCCESS = True
except ImportError as exc:
  logging.error('Could not import required Fuchsia-specific modules due to an '
                'ImportError %s. Any testing involving Fuchsia will not work!',
                exc)
...
def FindAllAvailableBrowsers(options, device):
  if not _FUCHSIA_IMPORT_SUCCESS:
    return []
