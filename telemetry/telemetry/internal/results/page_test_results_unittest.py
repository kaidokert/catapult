...
class PageTestResultsTest(base_test_results_unittest.BaseTestResultsUnittest):
  ...
  def testStringFailurePrintsStackTrace(self):
    output_stream = stream.TestOutputStream()
    reporter = gtest_progress_reporter.GTestProgressReporter(output_stream)
    ...
    self.assertEqual(
        ...
        '  File "/work/code/catapult/telemetry/telemetry/internal/results/page_test_results.py", line 464, in Fail\n'  # pylint: disable=line-too-long
        '    raise Exception(failure)\n'
        'Exception: foo\n\n'
        '[  FAILED  ] http://www.bar.com/ (0 ms)\n')
