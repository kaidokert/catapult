...
def ResultsAsChartDict(results):
  ...
  result_dict = {
      ...
      'benchmark_name': results.benchmark.name,
      'benchmark_description': results.benchmark.description,
      'benchmark_metadata': {
          'type': 'telemetry_benchmark',
          'name': results.benchmark.name,
          'description': results.benchmark.description,
      },
      'charts': charts,
...
class ChartJsonOutputFormatter(output_formatter.OutputFormatter):
  ...
  def FormatDisabled(self, results):
    self._Dump(DisabledResultsDict(results.benchmark.name))
