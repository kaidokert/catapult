...
class ArtifactResults(object):
  ...
  @property
  def results(self):
    return dict(self._page_run_artifacts)

  def AddArtifactFromPageRun(self, page, name, artifact_path=None, data=None):
    """Adds an artifact.

    Args:
      * page: The page being currently executed
    ...
    self._page_run_artifacts[page.name][name] = artifact_path
