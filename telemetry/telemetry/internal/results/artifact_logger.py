...
artifact_impl = artifact_wrapper.ArtifactCompatabilityWrapperFactory(None)
...
def RegisterArtifactImplementation(artifact_implementation):
  ...
  Args:
    artifact_implementation: The artifact implementation to use for future
        ...
        artifact_compatibility_wrapper.ArtifactCompatabilityWrapperFactory.
  """
  global artifact_impl  # pylint: disable=global-statement
  artifact_impl = artifact_wrapper.ArtifactCompatabilityWrapperFactory(
