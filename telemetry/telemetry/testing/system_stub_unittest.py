...
class CloudStorageTest(unittest.TestCase):
  ...
  def testPermissionError(self):
    ...
    self.assertRaises(
        self.cloud_storage.CloudStoragePermissionError, self.cloud_storage.Get,
        self.cloud_storage.INTERNAL_BUCKET, 'preset_internal_file.wpr',
        os.path.join(os.path.sep, 'path', 'to', 'preset_internal_file.wpr'))
    self.assertRaises(
        self.cloud_storage.CloudStoragePermissionError, self.cloud_storage.GetIfChanged,
        os.path.join(os.path.sep, 'path', 'to', 'preset_internal_file.wpr'),
        self.cloud_storage.INTERNAL_BUCKET)
    self.assertRaises(
        self.cloud_storage.CloudStoragePermissionError, self.cloud_storage.List,
        self.cloud_storage.INTERNAL_BUCKET)
    self.assertRaises(
        self.cloud_storage.CloudStoragePermissionError, self.cloud_storage.Exists,
        self.cloud_storage.INTERNAL_BUCKET, 'preset_internal_file.wpr')
    self.assertRaises(
        self.cloud_storage.CloudStoragePermissionError, self.cloud_storage.Insert,
