...
# always available, and other platforms shouldn't depend on the fuchsia runners.
...
def run_ffx_command(cmd, target_id=None, check=True, **kwargs):
  ...
  # Imports fuchsia runner modules only when they are necessary to avoid
  # depending fuchsia runner on other platforms.
