...
class SystemTraceConfig(object):
  ...
  class CallstackSamplingArgs(object):

    def __init__(self, target_cmdlines, sampling_frequency_hz):
      """Arguments for Perfetto callstack sampling.
  ...
  def __init__(self):
    ...
    # Not None iff callstack sampling is enabled.
    self._callstack_sampling_args = None
  ...
  def GetTextConfig(self):
    ...
    if self._callstack_sampling_args is not None:
      ...
      """.format(
          frequency=self._callstack_sampling_args.sampling_frequency_hz,
          target_cmdlines=self._callstack_sampling_args
          .GenerateTextConfigForCmdlines())
  ...
  def EnableCallstackSampling(self, target_cmdlines, sampling_frequency_hz):
    """Enables Perfetto callstack sampling.
    ...
    Args:
      ...
      sampling_frequency_hz: Frequency for sampling callstacks.
    """
    self._callstack_sampling_args = self.CallstackSamplingArgs(
