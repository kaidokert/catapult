...
MAP_TAGS_TO_TYP_EXPECTATIONS_TAGS = {
    'All': set([]),
    'Android_Go': set(['android-globo']),
    'Android_One': set(['android-W6210']),
    ...
    'Mac_10.11': set(['snowleopard-10.11']),
    'Mac_10.12': set(['snowleopard-10.12']),
    'Nexus6_Webview': set(['android-Nexus-6', 'android-webview']),
    'Nexus5X_Webview': set(['android-Nexus-5X', 'android-webview']),
    'Android_Go_Webview': set(['android-globo', 'android-webview']),
