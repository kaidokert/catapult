...
"""
  ...
  def testParseExpectationLineNoConditions(self):
    parser = expectations_parser.TestExpectationParser(raw='#Empty')
    e = parser._ParseExpectationLine('crbug.com/12345 b1/s1 [ Skip ]', ['All'])
    expected_outcome = {
  ...
  def testParseExpectationLineNoBug(self):
    parser = expectations_parser.TestExpectationParser(raw='#Empty')
    e = parser._ParseExpectationLine('[ All ] b1/s1 [ Skip ]', ['All'])
    expected_outcome = {
  ...
  def testParseExpectationLineNoBugNoConditions(self):
    parser = expectations_parser.TestExpectationParser(raw='#Empty')
    e = parser._ParseExpectationLine('b1/s1 [ Skip ]', ['All'])
    expected_outcome = {
