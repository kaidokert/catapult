...
from telemetry.internal.platform import simpleperf_controller
...
class SharedPageState(story_module.SharedState):
  ...
  def __init__(self, test, finder_options, story_set):
    ...
    self._simpleperf_controller = simpleperf_controller.SimpleperfController(
        process_name=finder_options.simpleperf_process,
  ...
  def RunStory(self, results):
    ...
    self._simpleperf_controller.GetResults(artifact_gen)
