...
class LegacyPageTest(object):
  ...
  def ValidateAndMeasurePage(self, page, tab, results):
    ...
    Call results.AddMeasurement(...) to record measurements with the current
    page run. Raise an exception or call results.Fail upon failure.
    legacy_page_test.py also provides several base exception classes
    to use.
