...
def _IsBenchmarkEnabled(bench, possible_browser, expectations_file, options):
  b = bench(
      use_new_expectations_format=options.use_new_test_expectations_format)
  expectations = _SetExpectations(b, expectations_file)
  expectations.InitExpectations(possible_browser.GetTypExpectationsTags())
  return (
...
def PrintBenchmarkList(
  ...
  for b in benchmarks:
    ...
    benchmark_info['enabled'] = (
        ...
        _IsBenchmarkEnabled(b, possible_browser, expectations_file, options))
