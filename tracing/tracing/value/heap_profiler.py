...
class HeapProfiler(object):
  ...
  def Profile(self, root, label=None, html_filename=None, html_stream=None,
      ...
      try:
        ...
        try:
          ...
          render_histograms_viewer.RenderHistogramsViewer(
              self._histograms.AsDicts(), html_stream, reset_results,
              vulcanized_viewer)
      else:
        vulcanize_histograms_viewer.VulcanizeAndRenderHistogramsViewer(
            self._histograms.AsDicts(), html_stream)
