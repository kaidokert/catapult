...
class HistogramGrouping(object):
  """This class wraps a named and registered function that maps from a Histogram
  to a string or number in order to allow grouping together Histograms that
  produce the same string or number. HistogramGroupings may be looked up by name
  (key) in BY_KEY.
  """
