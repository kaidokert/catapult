...
class GtestJsonConverterUnittest(unittest.TestCase):
  ...
  def testConvertBasic(self):
    ...
    self.assertEqual(story1.unit, 'ms')
    ...
    # assertAlmostEqual necessary to avoid floating point precision issues.
    self.assertAlmostEqual(story1.average, 100000)
    self.assertAlmostEqual(story1.standard_deviation, 2543.543)
    self.assertAlmostEqual(story2.average, 12345.6789)
    self.assertAlmostEqual(story2.standard_deviation, 301.2)
    self.assertEqual(story1.unit, story2.unit)
    self.assertEqual(story1.unit, 'ns')
  ...
  def testConvertUnknownUnit(self):
    ...
    self.assertEqual(story1.unit, story2.unit)
    self.assertEqual(story1.unit, 'unitless')
