...
@alert_groups.route('/test/<path:test_key>/start/<start_rev>/end/<end_rev>/sub/<sub_name>', methods=['GET'])
@utils.BearerTokenAuthorizer
def GetGroupsForAnomalyHandler(test_key, start_rev, end_rev, sub_name=None):
  try:
